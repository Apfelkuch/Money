...
public class MouseAdapterEntry extends MouseAdapter {
    ...
    public void mouseReleased(MouseEvent e) {
        ...
        if (e.getButton() == MouseEvent.BUTTON1 && (window.isInputEmpty() || window.isEntryShown())) {
            ...
            int result = ExtraWindow.confirmDialog(window, Phrases.deleteEntry, Phrases.deleteEntryMessage + entry.getNumber(), Phrases.inputFont, Phrases.BACKGROUND_LIGHT, Phrases.FOREGROUND, true);
